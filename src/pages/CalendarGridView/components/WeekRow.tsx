    ...
    return (
        <div className="mb-0">
            <div className="grid grid-cols-3 gap-px bg-gray-100 dark:bg-white/10 border-b border-gray-100 dark:border-white/10">
                <div className="col-span-2 relative bg-gray-50 dark:bg-white/5 min-h-[160px] p-2 flex flex-col justify-between group hover:bg-gray-100 dark:hover:bg-white/10 transition-colors">
